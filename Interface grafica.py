...
layout = [
    [psg.Text('Num1: '), psg.InputText(key='n1',size=15), psg.Frame('Opções: ', frame_layout)],
    [psg.Text('Num2: '), psg.InputText(key='n2',size=15)],
    [psg.Push(),psg.Text('Total'),psg.InputText(key='total', readonly=True, size=10), psg.Push()], # [psg.Text(key='total')],
